...
const heroElements: FloatingElementConfig[] = [
  {
    ...
    darkColor: "radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)",
  ...
  },
  {
    ...
    darkColor: "radial-gradient(circle, rgba(226,232,240,0.07) 0%, transparent 70%)",
  ...
  },
  {
    ...
    darkColor: "rgba(226,232,240,0.45)",
  ...
  },
  {
    ...
    darkColor: "rgba(203,213,225,0.5)",
  ...
  },
  {
    ...
    darkColor: "rgba(226,232,240,0.035)",
...
const sectionElements: FloatingElementConfig[] = [
  {
    ...
    darkColor: "radial-gradient(circle, rgba(255,255,255,0.05) 0%, transparent 70%)",
  ...
  },
  {
    ...
    darkColor: "rgba(226,232,240,0.3)",
...
const sparseElements: FloatingElementConfig[] = [
  ...
  },
  {
    ...
    darkColor: "rgba(226,232,240,0.25)",
    lightColor: "rgba(168,85,247,0.2)",
    darkOpacity: 1, lightOpacity: 1,
  },
]
